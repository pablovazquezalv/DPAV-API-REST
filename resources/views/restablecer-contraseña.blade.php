...
@endif
    <div class="mb-5">
      ...
      <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Nueva Contraseña:</label>
    ...
    <div class="mb-5">
      ...
      <input type="password" id="password"  name="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
    </div>
